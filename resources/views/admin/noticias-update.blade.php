...
@section('content')
    ...
    <section class="content">
      ...
      <form action="{{ URL::to('/') }}/cpanel/blog/update" method="post"  enctype="multipart/form-data" >
      	 {{  csrf_field() }}  
                ...
                <div class="form-group">
			 	 ...
			 	 <!----> <div class="form-group">
                        ...
                        <?php
                          ...
                          if(url_exists("http://www.caracasdigital.com/noticias/".$noticia[0]->fotos)) {
                            ?>
			 	 	              	<img src="http://www.caracasdigital.com/noticias/{{@$noticia[0]->fotos}}" class="form-control" style="width: 100px;height: 75px;" > 
                         

                        <?php }else{
                          ?>
                           <img src="{{ asset('noticias/'.$noticia[0]->fotos) }}" class="form-control" style="width: 200px;height: 150px;" > 
