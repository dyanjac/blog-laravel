		...
		<div class="td-big-grid-wrapper td-posts-5">
		 ...
		 <?php 
				...
				{	
					...
					for ( $p=0; 2 > $p ; $p++ ) 
					 {
							$title_ruta= post_slug($portadas[$p]->titulo); 
						
							
						
					    // $ruta1="http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[$p]->fotos);	
						//if(isset($portadas[$p]->fotos)){ }
                       // $ruta1="";

					  $ruta1=asset('noticias/'.$portadas[$p]->fotos);
                     

                       if(url_exists("http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[$p]->fotos)))
                        {
                         	$ruta1="http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[$p]->fotos);
                        } 

                        // if(url_exists(asset('noticias/'.$portadas[$p]->fotos)))
                        // {
					...
					<div class="td_module_mx25 td_module_wrap td-animation-stack td-big-grid-post-0 td-big-grid-post td-mx-15"> 
			            <div class="td-module-image">
			                ...
			                <div class="td-module-thumb"><a href="{{ URL::to('/') }}/{{$title_ruta}}/{{ $portadas[$p]->codNot }}" rel="bookmark" class="td-image-wrap" title="<?php echo $portadas[$p]->titulo;  ?>"><span class="entry-thumb td-thumb-css td-animation-stack-type0-1" style="background-image: url( <?php echo $ruta1; ?>)">
			                ...
			                <div class="td-meta-align">
			                    <div class="td-big-grid-meta">
			                       <h3 class="entry-title td-module-title">
			                       	<a href="{{ URL::to('/') }}/{{$title_ruta}}/{{ $portadas[$p]->codNot }}" rel="bookmark" title="<?php echo $portadas[$p]->titulo;  ?>"><?php echo $portadas[$p]->titulo; ?></a>
			                       </h3>                    
			                   </div>
