  <?php 
	 ...
	 $title_ruta2=post_slug($portadas[2]->titulo); 
	 $title_ruta3=post_slug($portadas[3]->titulo); 
	 $title_ruta4=post_slug($portadas[4]->titulo);
	 ...
	 $ruta3="";
	 $ruta4="";
	 $ruta2=asset('noticias/'.$portadas[$p]->fotos);
    
     if(url_exists("http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[2]->fotos)))
       {
         $ruta2="http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[2]->fotos);
        } 

       $ruta3=asset('noticias/'.$portadas[3]->fotos);
    
     if(url_exists("http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[3]->fotos)))
       {
         $ruta3="http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[3]->fotos);
        } 

      $ruta4=asset('noticias/'.$portadas[4]->fotos);
    
     if(url_exists("http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[4]->fotos)))
       {
         $ruta4="http://www.caracasdigital.com/noticias/".str_replace(' ', '%20', $portadas[4]->fotos);
        }      
        ...
        <div class="td-big-grid-scroll">
		        ...
		        <div class="td_module_mx19 td_module_wrap td-animation-stack td-big-grid-post-2 td-big-grid-post td-mx-23">
		            <div class="td-module-image">
		                <div class="td-module-thumb"><a href="{{ URL::to('/') }}/{{$title_ruta2}}/{{ $portadas[2]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$portadas[2]->titulo}}"><span class="entry-thumb td-thumb-css td-animation-stack-type0-1" style="background-image: url(<?php echo $ruta2;  ?>)"></span></a></div>            
		            </div>

		            <div class="td-meta-info-container">
		                <div class="td-meta-align">
		                    <div class="td-big-grid-meta">
		                     <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/{{$title_ruta2}}/{{ $portadas[2]->codNot }}" rel="bookmark" title="{{$portadas[2]->titulo}}"><?php echo $portadas[2]->titulo; ?></a></h3>                    </div>

		                    <div class="td-module-meta-info">
		                        <span class="td-post-date">
		                        	<time class="entry-date updated td-module-date" datetime="<?php echo $portadas[2]->fecha; ?>"><?php echo $portadas[2]->ffecha; ?></time>
		                        </span>                    
		                    </div>
		                </div>
		            </div>
		        ...
		        <div class="td_module_mx25 td_module_wrap td-animation-stack td-big-grid-post-3 td-big-grid-post td-mx-15">
		            <div class="td-module-image">
		                <div class="td-module-thumb"><a href="{{ URL::to('/') }}/{{$title_ruta3}}/{{ $portadas[3]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$portadas[3]->titulo}}"><span class="entry-thumb td-thumb-css td-animation-stack-type0-1" style="background-image: url(<?php echo $ruta3;  ?>)"></span></a></div>            
		            </div>

		            <div class="td-meta-info-container">
		                <div class="td-meta-align">
		                    <div class="td-big-grid-meta">
		                     <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/{{$title_ruta3}}/{{ $portadas[3]->codNot }}" rel="bookmark" title="{{$portadas[3]->titulo}}"><?php echo $portadas[3]->titulo; ?></a></h3>                    </div>

		                     <div class="td-module-meta-info">
		                        <span class="td-post-date">
		                        	<time class="entry-date updated td-module-date" datetime="<?php echo $portadas[3]->fecha; ?>"><?php echo $portadas[3]->ffecha; ?></time>
		                        </span>                    
		                    </div>
		        ...
		        <div class="td_module_mx25 td_module_wrap td-animation-stack td-big-grid-post-4 td-big-grid-post td-mx-15">
		            <div class="td-module-image">
		                <div class="td-module-thumb"><a href="{{ URL::to('/') }}/{{$title_ruta4}}/{{ $portadas[4]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$portadas[4]->titulo}}"><span class="entry-thumb td-thumb-css td-animation-stack-type0-1" style="background-image: url(<?php echo $ruta4;  ?>)"></span></a></div>            </div>

		            <div class="td-meta-info-container">
		                <div class="td-meta-align">
		                    <div class="td-big-grid-meta">
		                       <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/{{$title_ruta4}}/{{ $portadas[4]->codNot }}" rel="bookmark" title="{{$portadas[4]->titulo}}"><?php echo $portadas[4]->titulo; ?></a></h3>                   
		                   </div>
		                   <div class="td-module-meta-info">
		                        <span class="td-post-date">
		                        	<time class="entry-date updated td-module-date" datetime="<?php echo $portadas[4]->fecha; ?>"><?php echo $portadas[4]->ffecha; ?></time>
		                        </span>                    
		                    </div>
		                </div>
		            </div>
...
<?php 
	...
	for( $r=0 ; intval( (count($noticias) / 2 )) > $r; $r++  ) 
	{
		...
		$title_ruta_noti1= post_slug($noticias[($r*2)]->titulo); 
		$title_ruta_noti2= post_slug($noticias[(($r*2)+1)]->titulo); 
						
		
		//"http://www.caracasdigital.com/noticias/pe/".$noticias[($r*2)]->fotos;

		$izquierda=asset('noticias/'.$noticias[($r*2)]->fotos);
        if(url_exists("http://www.caracasdigital.com/noticias/pe/".$noticias[($r*2)]->fotos))
        {
          	$izquierda="http://www.caracasdigital.com/noticias/pe/".$noticias[($r*2)]->fotos;
         } 


        $derecha=asset('noticias/'.$noticias[(($r*2)+1)]->fotos);

        if(url_exists("http://www.caracasdigital.com/noticias/pe/".$noticias[(($r*2)+1)]->fotos))
        {
          	$derecha="http://www.caracasdigital.com/noticias/pe/".$noticias[(($r*2)+1)]->fotos;
         }  
		//"http://www.caracasdigital.com/noticias/pe/".$noticias[(($r*2)+1)]->fotos;
	...
	<div class="td-block-row">
			...
			<div class="td-block-span6">
		        ...
		        <div class="td-module-thumb"><a href="{{ URL::to('/') }}/{{$title_ruta_noti1}}/{{ $noticias[($r*2)]->codNot }}" rel="bookmark" class="td-image-wrap" title="<?php echo $noticias[($r*2)]->titulo; ?>"><img width="100" height="70" class="entry-thumb td-animation-stack-type0-1" src="{{$izquierda}}" srcset="{{$izquierda}}" sizes="(max-width: 100px) 100vw, 100px" alt="" title="<?php echo $noticias[($r*2)]->titulo; ?>"></a></div>
		        <div class="item-details">
		            <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/{{$title_ruta_noti1}}/{{ $noticias[($r*2)]->codNot }}" rel="bookmark" title="<?php echo $noticias[($r*2)]->titulo; ?>"><?php echo $noticias[($r*2)]->titulo; ?></a></h3>            
		            <div class="td-module-meta-info">
		              <span class="td-post-date">
		              	<time class="entry-date updated td-module-date" datetime="<?php echo $noticias[($r*2)]->fecha; ?>"><?php echo $noticias[($r*2)]->ffecha; ?></time>
		              </span>                            
		          </div>
		        </div>
			...
			<div class="td-block-span6">
		        ...
		        <div class="td-module-thumb"><a href="{{ URL::to('/') }}/{{$title_ruta_noti2}}/{{ $noticias[(($r*2)+1)]->codNot }}" rel="bookmark" class="td-image-wrap" title="<?php echo $noticias[(($r*2)+1)]->titulo; ?>"><img width="100" height="70" class="entry-thumb td-animation-stack-type0-1" src="{{$derecha}}" srcset="{{$derecha}}" sizes="(max-width: 100px) 100vw, 100px" alt="" title="<?php echo $noticias[(($r*2)+1)]->titulo; ?>"></a></div>
		        <div class="item-details">
		            <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/{{$title_ruta_noti2}}/{{ $noticias[(($r*2)+1)]->codNot }}" rel="bookmark" title="<?php echo $noticias[(($r*2)+1)]->titulo; ?>"><?php echo $noticias[(($r*2)+1)]->titulo; ?></a></h3>            
		            <div class="td-module-meta-info">
		             <span class="td-post-date">
		             	<time class="entry-date updated td-module-date" datetime="<?php echo $noticias[(($r*2)+1)]->fecha; ?>"><?php echo $noticias[(($r*2)+1)]->ffecha; ?>
...
<div class="td_block_wrap td_block_25 td_uid_9_5f8f778c078a7_rand td-pb-border-top td_block_template_3 td-column-2" data-td-block-uid="td_uid_9_5f8f778c078a7"  style="display: none;"><script>var block_td_uid_9_5f8f778c078a7 = new tdBlock();
...
<div class="td-block-title-wrap" >
	...
	<div class="td_block_wrap td_block_25 td_uid_22_5f8f778c16cff_rand td-pb-border-top td_block_template_3 td-column-2" data-td-block-uid="td_uid_22_5f8f778c16cff"  style="display: none;"><script>var block_td_uid_22_5f8f778c16cff = new tdBlock();
...
tdBlocksArray.push(block_td_uid_22_5f8f778c16cff);
	...
	<div class="td_block_wrap td_block_15 td_uid_27_5f8f778c21861_rand td-pb-border-top td_block_template_10 td-column-2 td_block_padding" data-td-block-uid="td_uid_27_5f8f778c21861"
	 style="display: none;"><script>var block_td_uid_27_5f8f778c21861 = new tdBlock();
...
<p><!-- VERTIV --></p>
<div align="center" style="display: none;"><a href="https://vertiv.biz/Inicieahora-GXT5-SP-V2" target="new" rel="noopener noreferrer"><img loading="lazy" src="https://i2.wp.com/www.itwarelatam.com/wp-content/uploads/2020/06/Vertiv_Liebert_GXT5_300x250.gif?resize=300%2C250&amp;ssl=1" alt="" width="300" height="250" data-recalc-dims="1"> </a></div>
<p><!--Hikvision
...
--><br>
<!-- PC Discount--></p>
<div align="center" style="display: none;"><a href="https://docs.google.com/forms/d/e/1FAIpQLScaj0-2F7s-_jolbCFJcrpL4FNBdRmneDKxPdv58gb8Lv-UBw/viewform" target="new" rel="noopener noreferrer"><img loading="lazy" class="aligncenter size-full wp-image-45079" src="https://i0.wp.com/www.enfasys.net/wp-content/uploads/2020/01/pc-discount-banner-300x250_enfasys-modificado-1.gif?resize=300%2C250&amp;ssl=1" alt="" width="300" height="250" data-recalc-dims="1"></a></div>
<p><!--BANNER_Croudstrike--></p>

<div align="center" style="display: none;"><a href="https://registro.contenidoscrowdstrike.com/freetrial/?utm_source=mediaware&amp;utm_medium=banner&amp;utm_campaign=free_trial" target="new" rel="noopener noreferrer"><br>
<img src="https://i1.wp.com/www.enfasys.net/wp-content/uploads/2020/10/300x250-CS-Free-Trial-2.jpg?w=696&amp;ssl=1" alt="" width="300" height="250"></a>
</div>
</div>
		</aside>
		...
		<div class="td_block_wrap td_block_7 td_block_widget td_uid_30_5f8f778c322db_rand td-pb-border-top td_block_template_3 td-column-1 td_block_padding" data-td-block-uid="td_uid_30_5f8f778c322db"  style="display: none;" >
<style>
...
<div class="td-block-title-wrap"><h4 class="td-block-title"><a href="https://http://www.caracasdigital.com/tag/veeam/" class="td-pulldown-size">Veeam News</a></h4></div>

<div id="td_uid_30_5f8f778c322db" class="td_block_inner">
...
<aside class="td_block_template_3 widget widget_text">			<div class="textwidget"><p><ins class="dcmads" style="display: inline-block; width: 300px; height: 250px; text-decoration: none;" data-dcm-placement="N410401.3657030ITWARELATAM.COM/B23030841.267588658" data-dcm-rendering-mode="iframe" data-dcm-https-only="" data-dcm-resettable-device-id="" data-dcm-app-id="" data-dcm-processed="y"><br>
  <script src="https://www.googletagservices.com/dcm/dcmads.js"></script><script src="https://www.googletagservices.com/dcm/impl_v63.js"></script><iframe marginwidth="0" marginheight="0" scrolling="no" frameborder="0" title="advertisement" src="https://ad.doubleclick.net/ddm/adi/N410401.3657030ITWARELATAM.COM/B23030841.267588658;dc_ver=63.178;sz=300x250;osdl=1;u_sd=3;dc_adk=1861669956;ord=r5c7y0;dc_rfl=0,https%3A%2F%2Fwww.itwarelatam.com%2F%23$0;xdt=0;crlt=bZQo6bIhy4;sttr=30;prcl=s" style="width: 100%; height: 100%; border: 0px; margin: 0px; padding: 0px;"></iframe><br>
		...
		<div  style="display: none;" class="wpb_wrapper td_block_wrap vc_raw_html td_uid_31_5f8f778c389f2_rand "><div class="td-fix-index"><!-- BANNER NETSKOPE-->
<div id="container" align="center">
...
<div class="wpb_wrapper td_block_wrap vc_raw_html td_uid_33_5f8f778c38a47_rand " style="display: none;">
...
<?php 
	 ...
	 $title_mercaRuta1=post_slug($mercadeo1[0]->titulo);
	 $title_mercaRuta2=post_slug($mercadeo1[1]->titulo);
	 $title_mercaRuta3=post_slug($mercadeo1[2]->titulo);
	 $title_mercaRuta4=post_slug($mercadeo1[3]->titulo);
	 $title_mercaRuta5=post_slug($mercadeo1[4]->titulo);
	 $title_mercaRuta6=post_slug($mercadeo1[5]->titulo);
	 @$title_mercaRuta7=post_slug($mercadeo1[6]->titulo);
?>
	<!-- <h2>#quedateencasa #somosresponsables #stayhome #staysafe #covid19</h2> -->
...
</style><div id="td_uid_35_5f9612feaf4fb" class="td_block_inner">

	<div class="td-big-grid-wrapper">
        <div class="td_module_mx12 td-animation-stack td-big-grid-post-0 td-big-grid-post td-small-thumb">
            <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta1}}/{{ $mercadeo1[0]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$mercadeo1[0]->titulo}}"><img width="356" height="220" class="entry-thumb td-animation-stack-type0-2" src="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[0]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[0]->fotos}}" sizes="(max-width: 356px) 100vw, 356px" alt="" title="{{$mercadeo1[0]->titulo}}"></a></div>            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta1}}/{{ $mercadeo1[0]->codNot }}" class="td-post-category">Mercadeo</a>
                        <h3 class="entry-title td-module-title">
                        	<a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta1}}/{{ $mercadeo1[0]->codNot }}" rel="bookmark" title="{{$mercadeo1[0]->titulo}}">{{$mercadeo1[0]->titulo}}</a></h3>                    </div>
                    <div class="td-module-meta-info">
                                                <span class="td-post-date"><time class="entry-date updated td-module-date" datetime="{{$mercadeo1[0]->fecha}}">{{$mercadeo1[0]->ffecha}}</time></span>                    </div>
                </div>
            </div>
        ...
        <div class="td_module_mx12 td-animation-stack td-big-grid-post-1 td-big-grid-post td-small-thumb">
            <div class="td-module-thumb">
            	<a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta2}}/{{ $mercadeo1[1]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$mercadeo1[1]->titulo}}">
            		<img width="356" height="220" class="entry-thumb td-animation-stack-type0-2" src="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[1]->fotos}}" alt="" title="{{$mercadeo1[1]->titulo}}"></a></div>            
            		<div class="td-meta-info-container">
	                <div class="td-meta-align">
	                    <div class="td-big-grid-meta">
	                        <a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta2}}/{{ $mercadeo1[1]->codNot }}" class="td-post-category">Mercadeo</a>
	                        <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta2}}/{{ $mercadeo1[1]->codNot }}" rel="bookmark" title="{{$mercadeo1[1]->titulo}}">{{$mercadeo1[1]->titulo}}</a></h3>                    </div>
	                    <div class="td-module-meta-info">
	                                                <span class="td-post-date"><time class="entry-date updated td-module-date" datetime="{{$mercadeo1[1]->fecha}}">{{$mercadeo1[0]->ffecha}}</time></span>                    </div>
	                </div>
            </div>
        ...
        <div class="td_module_mx12 td-animation-stack td-big-grid-post-2 td-big-grid-post td-small-thumb">
            <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta3}}/{{ $mercadeo1[2]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$mercadeo1[2]->titulo}}"><img width="356" height="220" class="entry-thumb td-animation-stack-type0-2" src="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[2]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[2]->fotos}}" sizes="(max-width: 356px) 100vw, 356px" alt="" title="{{$mercadeo1[2]->titulo}}"></a> </div>            
            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta3}}/{{ $mercadeo1[2]->codNot }}" class="td-post-category">Mercadeo</a>                        
                        <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta3}}/{{ $mercadeo1[2]->codNot }}" rel="bookmark" title="{{$mercadeo1[2]->titulo}}">
                        	{{$mercadeo1[2]->titulo}}</a>
                        </h3>                    
                    </div>
                    <div class="td-module-meta-info">
                       <span class="td-post-date"><time class="entry-date updated td-module-date" datetime="{{$mercadeo1[2]->fecha}}">{{$mercadeo1[2]->ffecha}}</time></span>                    
                   </div>
                </div>
            </div>
        ...
        <div class="td_module_mx6 td-animation-stack td-big-grid-post-3 td-big-grid-post td-small-thumb">
            <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta4}}/{{ $mercadeo1[3]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$mercadeo1[3]->titulo}}"><img width="265" height="198" class="entry-thumb td-animation-stack-type0-2" src="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[3]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[3]->fotos}}" sizes="(max-width: 265px) 100vw, 265px" alt="" title="{{$mercadeo1[2]->titulo}}"></a></div>            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta4}}/{{ $mercadeo1[3]->codNot }}" class="td-post-category">Opinion</a>                        <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta4}}/{{ $mercadeo1[3]->codNot }}" rel="bookmark" title="{{$mercadeo1[3]->titulo}}">{{$mercadeo1[3]->titulo}}</a></h3>                    </div>
                </div>
            </div>
        ...
        <div class="td_module_mx6 td-animation-stack td-big-grid-post-4 td-big-grid-post td-small-thumb">
            <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta5}}/{{ $mercadeo1[4]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$mercadeo1[4]->titulo}}"><img width="265" height="198" class="entry-thumb td-animation-stack-type0-2" src="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[4]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[4]->fotos}}" sizes="(max-width: 265px) 100vw, 265px" alt="" title="{{$mercadeo1[4]->titulo}}"></a></div>            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta5}}/{{ $mercadeo1[4]->codNot }}" class="td-post-category">Mercadeo</a>                        <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta5}}/{{ $mercadeo1[4]->codNot }}" rel="bookmark" title="{{$mercadeo1[4]->titulo}}">{{$mercadeo1[4]->titulo}}</a></h3>                    </div>
                </div>
            </div>
        ...
        <div class="td_module_mx6 td-animation-stack td-big-grid-post-5 td-big-grid-post td-small-thumb">
            <div class="td-module-thumb">
            	<a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta6}}/{{ $mercadeo1[5]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$mercadeo1[5]->titulo}}"><img width="265" height="198" class="entry-thumb td-animation-stack-type0-2" src="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[5]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[5]->fotos}}" sizes="(max-width: 265px) 100vw, 265px" alt="" title="{{$mercadeo1[5]->titulo}}"></a></div>            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta6}}/{{ $mercadeo1[5]->codNot }}" class="td-post-category">Mercado</a>                        <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta6}}/{{ $mercadeo1[5]->codNot }}" rel="bookmark" title="{{$mercadeo1[5]->titulo}}">{{$mercadeo1[5]->titulo}}</a></h3>                    </div>
                </div>
            </div>
        ...
        @if(isset($mercadeo1[6]->titulo))
        <div class="td_module_mx6 td-animation-stack td-big-grid-post-6 td-big-grid-post td-small-thumb">
            <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta7}}/{{ $mercadeo1[6]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$mercadeo1[6]->titulo}}"><img width="265" height="198" class="entry-thumb td-animation-stack-type0-2" src="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[6]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/{{$mercadeo1[6]->fotos}}" sizes="(max-width: 265px) 100vw, 265px" alt="" title="{{$mercadeo1[6]->titulo}}"></a></div>            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta7}}/{{ $mercadeo1[6]->codNot }}" class="td-post-category">Mercado</a>                        <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta7}}/{{ $mercadeo1[6]->codNot }}" rel="bookmark" title="{{$mercadeo1[6]->titulo}}">{{$mercadeo1[6]->titulo}}</a></h3>                    </div>
                </div>
            </div>
        ...
        @else
             ...
             <div class="td_module_mx6 td-animation-stack td-big-grid-post-6 td-big-grid-post td-small-thumb">
            <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta7}}/{{ $noticias_mercadeo[0]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{$noticias_mercadeo[0]->titulo}}"><img width="265" height="198" class="entry-thumb td-animation-stack-type0-2" src="http://www.caracasdigital.com/nmercadeos/{{$noticias_mercadeo[0]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/{{$noticias_mercadeo[0]->fotos}}" sizes="(max-width: 265px) 100vw, 265px" alt="" title="{{$noticias_mercadeo[0]->titulo}}"></a></div>            <div class="td-meta-info-container">
                <div class="td-meta-align">
                    <div class="td-big-grid-meta">
                        <a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta7}}/{{ $noticias_mercadeo[0]->codNot }}" class="td-post-category">Mercado</a>                        <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_mercaRuta7}}/{{ $noticias_mercadeo[0]->codNot }}" rel="bookmark" title="{{$noticias_mercadeo[0]->titulo}}">{{$noticias_mercadeo[0]->titulo}}</a></h3>                    </div>
                </div>
            </div>
...
<div class="td-block-title-wrap">
	...
	<h4 class="block-title td-block-title"><a href="https://http://www.caracasdigital.com/category/empresas-2/" class="td-pulldown-size">Negocios & Mercadeo</a></h4>
...
<?php for ( $a=0 ; intval(count($noticias_mercadeo)/3) > $a; $a++ ) {


	//echo $noticias_mercadeo[($a)]->codNot;
?>

<div id="td_uid_40_5f8f778c444e1" class="td_block_inner">

	

	<div class="td-block-row">
<div class="td-block-span4">
			<?php if($noticias_mercadeo[($a*3)]->codNot) { 

				$title_ruta_nm_col1=post_slug($noticias_mercadeo[($a*3)]->titulo); 
				?>
			
            	<div class="td_module_6 td_module_wrap td-animation-stack">

					        <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_ruta_nm_col1}}/{{ $noticias_mercadeo[($a*3)]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{ $noticias_mercadeo[($a*3)]->titulo }}">
					        	<img width="100" height="70" class="entry-thumb td-animation-stack-type0-1" src="http://www.caracasdigital.com/nmercadeos/pe/{{$noticias_mercadeo[($a*3)]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/pe/{{$noticias_mercadeo[($a*3)]->fotos}}"  style="height: 70px;width:100px; " ></a></div>
					        <div class="item-details">
					            <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_ruta_nm_col1}}/{{ $noticias_mercadeo[($a*3)]->codNot }}" rel="bookmark" title="{{ $noticias_mercadeo[($a*3)]->titulo }}">{{ $noticias_mercadeo[($a*3)]->titulo }}</a></h3>            <div class="td-module-meta-info">
					                                                <span class="td-post-date"><time class="entry-date updated td-module-date" datetime="{{ $noticias_mercadeo[($a*3)]->fecha }}">{{ $noticias_mercadeo[($a*3)]->ffecha }}</time></span>                            </div>
					        </div>
	...
	<?php if($noticias_mercadeo[($a*3)+1]->codNot) {

			$title_ruta_nm_col2=post_slug($noticias_mercadeo[($a*3)+1]->titulo);
	 ?>	
       

       		<div class="td_module_6 td_module_wrap td-animation-stack">

					        <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_ruta_nm_col2}}/{{ $noticias_mercadeo[($a*3)+1]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{ $noticias_mercadeo[($a*3)+1]->titulo }}"><img width="100" height="70" class="entry-thumb td-animation-stack-type0-1" src="http://www.caracasdigital.com/nmercadeos/pe/{{$noticias_mercadeo[($a*3)+1]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/pe/{{$noticias_mercadeo[($a*3)+1]->fotos}}" style="height: 70px;width:100px; "></a></div>
					        <div class="item-details">
					       <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_ruta_nm_col2}}/{{ $noticias_mercadeo[($a*3)+1]->codNot }}" rel="bookmark" title="{{ $noticias_mercadeo[($a*3)+1]->titulo}}"> {{ $noticias_mercadeo[($a*3)+1]->titulo }}</a></h3>            
					       <div class="td-module-meta-info">
					               <span class="td-post-date"><time class="entry-date updated td-module-date" datetime=" {{ $noticias_mercadeo[($a*3)+1]->fecha }}"> {{ $noticias_mercadeo[($a*3)+1]->ffecha}} </time></span>
					           </div>
					        </div>
	...
	<div class="td-block-span4">
			...
			<?php if($noticias_mercadeo[($a*3)+2]->codNot) { 
					$title_ruta_nm_col3=post_slug($noticias_mercadeo[($a*3)+2]->titulo);
				?>
        			<div class="td_module_6 td_module_wrap td-animation-stack">

					        <div class="td-module-thumb"><a href="{{ URL::to('/') }}/mercadeo/{{$title_ruta_nm_col3}}/{{ $noticias_mercadeo[($a*3)+2]->codNot }}" rel="bookmark" class="td-image-wrap" title="{{ $noticias_mercadeo[($a*3)+2]->titulo }}"><img width="100" height="70" class="entry-thumb td-animation-stack-type0-1" src="http://www.caracasdigital.com/nmercadeos/pe/{{$noticias_mercadeo[($a*3)+2]->fotos}}" srcset="http://www.caracasdigital.com/nmercadeos/pe/{{ $noticias_mercadeo[($a*3)+2]->fotos}}" style="height: 70px;width:100px; " ></a></div>
					        <div class="item-details">
					            <h3 class="entry-title td-module-title"><a href="{{ URL::to('/') }}/mercadeo/{{$title_ruta_nm_col3}}/{{ $noticias_mercadeo[($a*3)+2]->codNot }}" rel="bookmark" title="{{ $noticias_mercadeo[($a*3)+2]->titulo }}">{{ $noticias_mercadeo[($a*3)+2]->titulo }}</a></h3>            <div class="td-module-meta-info">
					               <span class="td-post-date"><time class="entry-date updated td-module-date" datetime="{{ $noticias_mercadeo[($a*3)+2]->fecha }}">{{ $noticias_mercadeo[($a*3)+2]->ffecha }}</time></span>                            </div>
					        </div>
...
<?php   } ?> 
	...
	<div class="td_block_wrap td_block_1 vc_custom_1586051327594 td_uid_105_5f8f778c5265f_rand td-pb-border-top td_block_template_1 td-column-3" data-td-block-uid="td_uid_105_5f8f778c5265f"  style="display: none;" >
		<script>var block_td_uid_105_5f8f778c5265f = new tdBlock();
...
<div class="td-block-title-wrap">
	<h4 class="block-title td-block-title"><a href="https://http://www.caracasdigital.com/category/canales/" class="td-pulldown-size">CANALES, MAYORISTAS Y DISTRIBUIDORES</a></h4></div>
	<div id="td_uid_105_5f8f778c5265f" class="td_block_inner">
...
<div class="vc_column td_uid_113_5f8f778c5f20a_rand  wpb_column vc_column_container tdc-column td-pb-span4" style="display: none;" ><div class="wpb_wrapper"><div class="td_block_wrap td_block_19 td_uid_114_5f8f778c5f4fe_rand td-pb-border-top td_block_template_10 td-column-1" data-td-block-uid="td_uid_114_5f8f778c5f4fe"><script>var block_td_uid_114_5f8f778c5f4fe = new tdBlock();
...
<div class="td-block-title-wrap"><h4 class="td-block-title"><a href="https://http://www.caracasdigital.com/category/tipo-de-nota/internet/" class="td-pulldown-size">INTERNET</a></h4></div><div id="td_uid_114_5f8f778c5f4fe" class="td_block_inner td-column-1">
        ...
        <div class="vc_column td_uid_115_5f8f778c66b2e_rand  wpb_column vc_column_container tdc-column td-pb-span4"  style="display: none;"  >


        	<div class="wpb_wrapper"><div class="td_block_wrap td_block_19 td_uid_116_5f8f778c66d0a_rand td-pb-border-top td_block_template_10 td-column-1" data-td-block-uid="td_uid_116_5f8f778c66d0a"><script>var block_td_uid_116_5f8f778c66d0a = new tdBlock();
...
tdBlocksArray.push(block_td_uid_116_5f8f778c66d0a);
 ...
 <div class="vc_column td_uid_117_5f8f778c6dbee_rand  wpb_column vc_column_container tdc-column td-pb-span4" style="display: none;"  >

        	<div class="wpb_wrapper">
        		<div class="td_block_wrap td_block_19 td_uid_118_5f8f778c6dd06_rand td-pb-border-top td_block_template_10 td-column-1" data-td-block-uid="td_uid_118_5f8f778c6dd06"><script>var block_td_uid_118_5f8f778c6dd06 = new tdBlock();
...
<div class="td-block-title-wrap"><h4 class="td-block-title"><a href="https://http://www.caracasdigital.com/category/tipo-de-nota/opinion/" class="td-pulldown-size">OPINIÓN</a></h4></div><div id="td_uid_118_5f8f778c6dd06" class="td_block_inner td-column-1">
        <div class="td_module_mx1 td_module_wrap td-animation-stack">
...
<div class="vc_column td_uid_125_5f8f778c7cdde_rand  wpb_column vc_column_container tdc-column td-pb-span4" style="display: none;">
	<div class="wpb_wrapper">
		<div class="td_block_wrap td_block_19 td_uid_126_5f8f778c7ceda_rand td-pb-border-top td_block_template_10 td-column-1" data-td-block-uid="td_uid_126_5f8f778c7ceda"><script>var block_td_uid_126_5f8f778c7ceda = new tdBlock();
...
<div class="td-block-title-wrap"><h4 class="td-block-title"><a href="https://http://www.caracasdigital.com/category/tipo-de-nota/tendencias/" class="td-pulldown-size">TENDENCIAS</a></h4></div><div id="td_uid_126_5f8f778c7ceda" class="td_block_inner td-column-1">
        <div class="td_module_mx1 td_module_wrap td-animation-stack">
        ...
        <div class="vc_column td_uid_127_5f8f778c83f8a_rand  wpb_column vc_column_container tdc-column td-pb-span4" style="display: none;" >
        	<div class="wpb_wrapper">
        		<div class="td_block_wrap td_block_19 td_uid_128_5f8f778c840a8_rand td-pb-border-top td_block_template_10 td-column-1" data-td-block-uid="td_uid_128_5f8f778c840a8"><script>var block_td_uid_128_5f8f778c840a8 = new tdBlock();
			...
			<div class="td-block-title-wrap"><h4 class="td-block-title"><a href="https://http://www.caracasdigital.com/category/tipo-de-nota/eventos/" class="td-pulldown-size">EVENTOS</a></h4></div>
			<div id="td_uid_128_5f8f778c840a8" class="td_block_inner td-column-1">
        ...
        <div class="vc_column td_uid_129_5f8f778c8cd1c_rand  wpb_column vc_column_container tdc-column td-pb-span4" style="display: none;" ><div class="wpb_wrapper"><div class="td_block_wrap td_block_19 td_uid_130_5f8f778c8ce41_rand td-pb-border-top td_block_template_10 td-column-1" data-td-block-uid="td_uid_130_5f8f778c8ce41">
        	<script>var block_td_uid_130_5f8f778c8ce41 = new tdBlock();
		...
		<div class="td-block-title-wrap"><h4 class="td-block-title"><a href="https://http://www.caracasdigital.com/category/tipo-de-nota/videoentrevistas/" class="td-pulldown-size">VIDEO ENTREVISTAS</a></h4></div>

			<div id="td_uid_130_5f8f778c8ce41" class="td_block_inner td-column-1">
